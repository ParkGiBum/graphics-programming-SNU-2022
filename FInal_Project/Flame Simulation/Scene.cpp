...
Scene::Scene(void)
{
	...
	m_pointsShader->setFloat("type", 2);
	m_point_small_Shader = new Shader(PARTICLE_SHADER);
	m_point_small_Shader->setFloat("type", 1);
	//m_pointsShader->time = SDL_GetTicks();
	...
	m_objects.push_back(new Object(m_logMesh, m_logMat,&m_deltaTime, glm::vec3(0.05f,0.02f,0.05f), glm::vec3(0.0f,0.1,0), glm::vec3(3.1415,0,0)));
	m_objects.push_back(new Object(m_logMesh, m_logMat,&m_deltaTime, glm::vec3(0.05f,0.02f,0.05f), glm::vec3(0,0.1,0.0f), glm::vec3(3.1415,1.57079632679f,0)));
